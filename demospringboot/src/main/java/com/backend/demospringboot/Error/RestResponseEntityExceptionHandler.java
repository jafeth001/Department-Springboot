...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    @ExceptionHandler(DepartmemtNotFoundException.class)
    public ResponseEntity<ErrorMessage> departmentExceptionNotfound
            (DepartmemtNotFoundException ex, WebRequest request){
